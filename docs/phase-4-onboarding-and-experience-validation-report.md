...
- Current-session settlement review derived from session state only, including feature use, overload/bust previews, and canceled risky previews; no persistence or telemetry.
- Player-test template for the required real-player follow-up.

## Validation

- `pnpm validate`: PASS (23 test files / 121 tests; architecture check PASS; gzip JavaScript 73.22KB).
